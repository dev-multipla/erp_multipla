...
function ContaPagarForm() {
        ...
        const fetchData = async () => {
            try {
                ...
                const [contratosResponse, formasPagamentoResponse, projetosResponse] = await Promise.all([
                    axios.get('http://127.0.0.1:8000/api/contratos/fornecedor/', { headers }),
                ...
                // Fazendo a requisição para buscar os dados dos cartões
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            await axios.post('http://127.0.0.1:8000/api/contas-pagar/', payload, { headers });
